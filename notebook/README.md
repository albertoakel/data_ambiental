...
### [Mapa_Bairros_plotly](Mapa_Bairros_plotly.ipynb)
...
### [Mapa_Setores_coleta_Folium](Mapa_Setores_coleta_Folium.ipynb)

Cria um mapa interativo dos setores de coleta de lixo, mostrando:

### [ML_random_forest](ML_random_forest.ipynb)
...
### [preprocessamento_Bairros_IBGE](preprocessamento_Bairros_IBGE.ipynb)
...
### [Processamento_shape](Processamento_shape.ipynb)
